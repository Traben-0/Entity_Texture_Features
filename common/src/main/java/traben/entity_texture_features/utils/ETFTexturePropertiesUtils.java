        ...
        public boolean doesEntityMeetConditionsOfThisCase(Entity entity, boolean isUpdate, Object2BooleanOpenHashMap<UUID> UUID_CaseHasUpdateablesCustom) {
            ...
            if (doesEntityMeetThisCaseTest && HEIGHT_Y_VALUES != null) {
                ...
                if (isUpdate && ETFConfigData.restrictHeight && ETFConfigData.restrictUpdateProperties && spawnConditions != null && spawnConditions.size() > 2) {
                    ...
                    entityHeight = entity.getBlockPos().getY();
                }
                boolean check = false;
                for (int i :
                        HEIGHT_Y_VALUES) {
            ...
            if (doesEntityMeetThisCaseTest && COLOR_VALUES != null) {
                ...
                if (entity instanceof WolfEntity) {
                    entityColor = ((WolfEntity) entity).getCollarColor().getName().toLowerCase();
                } else if (entity instanceof SheepEntity) {
                    entityColor = ((SheepEntity) entity).getColor().getName().toLowerCase();
                    ...
                    entityColor = ((CatEntity) entity).getCollarColor().getName().toLowerCase();
...
//            }
            ...
            if (doesEntityMeetThisCaseTest && MOVING != null) {
                ...
                doesEntityMeetThisCaseTest = (
                        ...
                        horizontalLength(entity.getVelocity()) == 0.0
                ) != MOVING;
            }
        ...
        public double horizontalLength(Vec3d vec) {
            return (double) MathHelper.sqrt(vec.x * vec.x + vec.z * vec.z);
        }
        ...
        private ImmutableList<String> readAllSpawnConditionsForCache(@NotNull Entity entity) {
            ...
            @NotNull String height = !ETFConfigData.restrictHeight ? "" : "" + entity.getBlockPos().getY();
