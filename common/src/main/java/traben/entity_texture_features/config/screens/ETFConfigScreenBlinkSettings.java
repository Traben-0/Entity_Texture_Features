    ...
    protected void init() {
        ...
        this.addButton(getETFButton((int) (this.width * 0.25), (int) (this.height * 0.9), (int) (this.width * 0.2), 20,
                ...
                (button) -> {
                    ...
                    Objects.requireNonNull(client).openScreen(new ETFConfigScreenBlinkSettings(parent));
                    this.removed();
                }));
        ...
        if (sliderWidth > 1600)
            sliderHeight = 16;
        this.addButton(new SliderWidget((int) (this.width * 0.025), (int) (this.height * 0.3), (int) (this.width * 0.45), sliderHeight,
        ...
        this.addButton(new SliderWidget((int) (this.width * 0.025), (int) (this.height * 0.4), (int) (this.width * 0.45), sliderHeight,
