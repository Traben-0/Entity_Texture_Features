...
//            renderEntitySample(matrices, mouseY);
//        } else {
...
//        context.multiplyPositionMatrix((new Matrix4f()).scaling(scaling, scaling, -scaling));
//        context.multiply(quaternionf);
//        DiffuseLighting.method_34742();
//
...
//        LOGO_CREEPER.renderSimple(matrixStack, MinecraftClient.getInstance().getBufferBuilders().getEntityVertexConsumers(), YELLOW);
//        matrixStack.pop();
//        matrixStack.push();
//        matrixStack.translate(0, -sin2, 0);
//        matrixStack.scale(1 + sin2, 1 + sin2, 1 + sin2);
//        LOGO_CREEPER.renderSimple(matrixStack, MinecraftClient.getInstance().getBufferBuilders().getEntityVertexConsumers(), RED);
//        matrixStack.pop();
//        matrixStack.push();
//        matrixStack.translate(0.6, -sin3, 0);
//        matrixStack.scale(1 + sin3, 1 + sin3, 1 + sin3);
//        LOGO_CREEPER.renderSimple(matrixStack, MinecraftClient.getInstance().getBufferBuilders().getEntityVertexConsumers(), BLUE);
//        matrixStack.pop();
//
//        DiffuseLighting.enableGuiDepthLighting();
//    }
//
//    private void renderEntitySample(final MatrixStack context, final int mouseY) {
//        int y = (int) (this.height * 0.75);
