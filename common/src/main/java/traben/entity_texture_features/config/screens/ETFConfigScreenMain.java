...
//        }
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget((int) (this.width * 0.3) + 75, (int) (this.height * 0.5) + 17, 165, 20,
        ...
        this.addButton(new ButtonWidget((int) (this.width * 0.3) + 75, (int) (this.height * 0.5) - 10, 165, 20,
        ...
        this.addButton(new ButtonWidget((int) (this.width * 0.3) + 75, (int) (this.height * 0.5) - 37, 165, 20,
        ...
        this.addButton(new ButtonWidget((int) (this.width * 0.3) + 75, (int) (this.height * 0.5) + 44, 165, 20,
