...
public class ETFConfigScreenSkinTool extends ETFConfigScreen {
    ...
    protected void init() {
        ...
        this.addButton(getETFButton(this.width / 2 - 210, (int) (this.height * 0.9), 200, 20, ScreenTexts.CANCEL, (button) -> {
            onExit();
            Objects.requireNonNull(client).openScreen(parent);
        }));

        this.addButton(getETFButton((int) (this.width * 0.024), (int) (this.height * 0.2), 20, 20,
                Text.of("⟳"),
        ...
        if (MinecraftClient.getInstance().player != null) {
            ...
            this.addButton(getETFButton((int) (this.width * 0.25), (int) (this.height * 0.2), (int) (this.width * 0.42), 20,
            ...
            villagerNoseButton = getETFButton((int) (this.width * 0.25), (int) (this.height * 0.7), (int) (this.width * 0.2), 20,
                    ...
                    (button) -> {
                        ...
                        currentEditorSkin.setPixelColor(53, 17, colour);
                        thisETFPlayerTexture.changeSkinToThisForTool(currentEditorSkin);
            ...
            capeButton = getETFButton((int) (this.width * 0.47), (int) (this.height * 0.7), (int) (this.width * 0.2), 20,
                    ...
                    (button) -> {
                        ...
                        currentEditorSkin.setPixelColor(53, 16, cape.getCapePixelColour());
            ...
            coatButton = getETFButton((int) (this.width * 0.25), (int) (this.height * 0.3), (int) (this.width * 0.42), 20,
                    ...
                    (button) -> {
                        ...
                        currentEditorSkin.setPixelColor(52, 17, coat.getCoatPixelColour());
            ...
            coatLengthButton = getETFButton((int) (this.width * 0.695), (int) (this.height * 0.3), (int) (this.width * 0.275), 20,
                    ...
                    (button) -> {
                        ...
                        currentEditorSkin.setPixelColor(52, 18, getPixelColour(lengthChoice));
                        thisETFPlayerTexture.changeSkinToThisForTool(currentEditorSkin);
            ...
            blinkButton = getETFButton((int) (this.width * 0.25), (int) (this.height * 0.4), (int) (this.width * 0.42), 20,
                    ...
                    (button) -> {
                        ...
                        if (blink != BlinkType.NONE
                            ...
                            currentEditorSkin.setPixelColor(52, 19, getPixelColour(0));
                        } else if (currentEditorSkin.getPixelColor(52, 19) > blink.getMaxEyePixelHeight()) {
                            //set height choice to the highest possible if too big for new type choice
                            currentEditorSkin.setPixelColor(52, 19, getPixelColour(blink.getMaxEyePixelHeight()));
                        }

                        currentEditorSkin.setPixelColor(52, 16, blink.getBlinkPixelColour());
            ...
            blinkHeightButton = getETFButton((int) (this.width * 0.695), (int) (this.height * 0.4), (int) (this.width * 0.275), 20,
                    ...
                    (button) -> {
                        ...
                        currentEditorSkin.setPixelColor(52, 19, getPixelColour(heightChoice));
                        thisETFPlayerTexture.changeSkinToThisForTool(currentEditorSkin);
            ...
            emissiveButton = getETFButton((int) (this.width * 0.25), (int) (this.height * 0.5), (int) (this.width * 0.42), 20,
                    Text.of(ETFVersionDifferenceHandler.getTextFromTranslation("config." + MOD_ID + ".player_skin_editor.emissive_enable.button").getString()
                            + (currentEditorSkin.getPixelColor(1, 17) == getPixelColour(1) ? ScreenTexts.ON : ScreenTexts.OFF).getString()),
                    (button) -> {


                        if (thisETFPlayerTexture.hasEmissives) {
                            currentEditorSkin.setPixelColor(1, 17, 0);
                        } else {
                            currentEditorSkin.setPixelColor(1, 17, getPixelColour(1));
                        }
            ...
            emissiveSelectButton = getETFButton((int) (this.width * 0.695), (int) (this.height * 0.5), (int) (this.width * 0.275), 20,
                    ...
                    (button) -> Objects.requireNonNull(client).openScreen(new ETFConfigScreenSkinToolPixelSelection(this, ETFConfigScreenSkinToolPixelSelection.SelectionMode.EMISSIVE))
            );
            ...
            enchantButton = getETFButton((int) (this.width * 0.25), (int) (this.height * 0.6), (int) (this.width * 0.42), 20,
                    Text.of(ETFVersionDifferenceHandler.getTextFromTranslation("config." + MOD_ID + ".player_skin_editor.enchant_enable.button").getString()
                            + (currentEditorSkin.getPixelColor(1, 18) == getPixelColour(2) ? ScreenTexts.ON : ScreenTexts.OFF).getString()),
                    (button) -> {


                        if (thisETFPlayerTexture.hasEnchant) {
                            currentEditorSkin.setPixelColor(1, 18, 0);
                        } else {
                            currentEditorSkin.setPixelColor(1, 18, getPixelColour(2));
                        }
            ...
            enchantSelectButton = getETFButton((int) (this.width * 0.695), (int) (this.height * 0.6), (int) (this.width * 0.275), 20,
                    ...
                    (button) -> Objects.requireNonNull(client).openScreen(new ETFConfigScreenSkinToolPixelSelection(this, ETFConfigScreenSkinToolPixelSelection.SelectionMode.ENCHANTED))
            );

            updateButtons();
            this.addButton(villagerNoseButton);
            this.addButton(coatButton);
            this.addButton(coatLengthButton);
            this.addButton(blinkButton);
            this.addButton(blinkHeightButton);
            this.addButton(emissiveButton);
            this.addButton(emissiveSelectButton);
            this.addButton(enchantButton);
            this.addButton(enchantSelectButton);
            this.addButton(capeButton);
    ...
    private void updateButtons() {
        ...
        if (emissiveSelectButton != null) {
            emissiveSelectButton.active = activeFeatures
                    && currentEditorSkin.getPixelColor(1, 17) == getPixelColour(1);
        }
        ...
        if (enchantSelectButton != null) {
            enchantSelectButton.active = activeFeatures
                    && currentEditorSkin.getPixelColor(1, 18) == getPixelColour(2);
        }
        if (capeButton != null) {
...
//            drawTextWithShadow(matrices, textRenderer, ETFVersionDifferenceHandler.getTextFromTranslation("config." + MOD_ID + ".player_skin_editor.iris_message"), width / 8, (int) (this.height * 0.15), 0xFF5555);
                ...
                for (int x = 0; x < currentEditorSkin.getWidth(); x++) {
                    for (int y = 0; y < currentEditorSkin.getHeight(); y++) {
                        ...
                        if (skinFeatureImage.getPixelColor(x, y) != 0) {
                            currentEditorSkin.setPixelColor(x, y, skinFeatureImage.getPixelColor(x, y));
                        }
                    }
                }
    ...
    public boolean printPlayerSkinCopy() {
        if ((ETFVersionDifferenceHandler.isFabric() == ETFVersionDifferenceHandler.isThisModLoaded("fabric")) && CONFIG_DIR != null) {
            File outputDirectory = new File(CONFIG_DIR.getParent(), "\\ETF_player_skin_printout.png");
            try {
                currentEditorSkin.writeFile(outputDirectory);
