            ...
            this.addButton(getETFButton((int) (this.width * 0.15), (int) (this.height * 0.4), (int) (this.width * 0.7), 20,
                    ...
                    (button) -> {
                        ...
                        if (changeSuccess) {
                            ...
                            PlayerSkinTexture skinfile = (PlayerSkinTexture) ((PlayerSkinProviderAccessor) MinecraftClient.getInstance().getSkinProvider()).getTextureManager().getTexture((MinecraftClient.getInstance().player).getSkinTexture());
                            try {
                                //System.out.println("file was ="+((PlayerSkinTextureAccessor)skinfile).getCacheFile().toString());
                                skin.writeFile(((PlayerSkinTextureAccessor) skinfile).getCacheFile());
                            } catch (IOException e) {
