...
public class ETFConfigScreenWarnings extends ETFConfigScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredTextWithShadow(matrices, textRenderer, ETFVersionDifferenceHandler.getTextFromTranslation("config." + ETFClientCommon.MOD_ID + ".warn_instruction").asOrderedText(), (int) (width * 0.5), (int) (height * 0.18), 0xFFFFFF);
        ...
        if (ETFClientCommon.configHadLoadError) {
            drawCenteredTextWithShadow(matrices, textRenderer, ETFVersionDifferenceHandler.getTextFromTranslation("config." + ETFClientCommon.MOD_ID + ".warn_config_load").asOrderedText(), (int) (width * 0.5), (int) (height * 0.28), 11546150);
            offset = 0.1;
        }
        ...
        for (ETFConfigWarning warning :
            ...
            drawTextWithShadow(matrices, textRenderer, ETFVersionDifferenceHandler.getTextFromTranslation(warning.getTitle()), (int) (this.width * 0.05), (int) (this.height * (0.25 + offset)), 0xFFFFFF);
//            if(warning.hasAction){
            drawTextWithShadow(matrices, textRenderer, ETFVersionDifferenceHandler.getTextFromTranslation(warning.getSubTitle()), (int) (this.width * 0.05), (int) (this.height * (0.29 + offset)), 0x888888);
