...
public class ETFConfigScreenRandomRestrictSettings extends ETFConfigScreen {
    ...
    protected void init() {
        ...
        this.addButton(getETFButton((int) (this.width * 0.25), (int) (this.height * 0.9), (int) (this.width * 0.22), 20,
                ...
                (button) -> {
                    ...
                    Objects.requireNonNull(client).openScreen(new ETFConfigScreenRandomRestrictSettings(parent));
                    this.onClose();
        ...
        this.addButton(getETFButton((int) (this.width * 0.27), (int) (this.height * 0.2), (int) (this.width * 0.45), 20,
                Text.of(ETFVersionDifferenceHandler.getTextFromTranslation(
