    ...
    protected void init() {
        ...
        this.addButton(getETFButton((int) (this.width * 0.25), (int) (this.height * 0.9), (int) (this.width * 0.2), 20,
                ...
                (button) -> {
                    ...
                    Objects.requireNonNull(client).openScreen(new ETFConfigScreenSkinSettings(parent));
                    this.removed();
                }));
        ...
        ButtonWidget skinTool = getETFButton((int) (this.width * 0.525), (int) (this.height * 0.4), (int) (this.width * 0.45), 20,
                ...
                (button) -> Objects.requireNonNull(client).openScreen(playerSkinEditorScreen),
