...
public class ETFConfigScreenWarnings extends TConfigScreen {
    ...
    public void render(MatrixStack context, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredTextWithShadow(context,textRenderer, ETFVersionDifferenceHandler.getTextFromTranslation("config." + ETF.MOD_ID + ".warn_instruction"), (int) (width * 0.5), (int) (height * 0.18), 0xFFFFFF);
        double offset = 0.0;
