...
public class ETF3DBodyLayerFeatureRenderer extends BodyLayerFeatureRenderer {
    ...
    @Override
    public void renderLayers(AbstractClientPlayerEntity abstractClientPlayer, CustomizableModelPart[] layers, MatrixStack matrixStack, VertexConsumer vertices, int light, int overlay) {
        ...
        if (thisETF != null) {
            ...
            super.renderLayers(abstractClientPlayer, layers, matrixStack, vertices, light, overlay);
