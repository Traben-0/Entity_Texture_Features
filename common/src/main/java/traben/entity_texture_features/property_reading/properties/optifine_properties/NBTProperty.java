...
import static traben.entity_texture_features.property_reading.properties.generic_properties.StringArrayOrRegexProperty.getStringMatcher_Regex_Pattern_List_Single;
...
public class NBTProperty extends RandomProperty {
    ...
    @Override
    protected boolean testEntityInternal(ETFEntity entity, boolean isUpdate, Object2BooleanOpenHashMap<String> spawnConditions) {

        NbtCompound entityNBT;
        Entity internal = entity.entity();
        if (internal != null) {
