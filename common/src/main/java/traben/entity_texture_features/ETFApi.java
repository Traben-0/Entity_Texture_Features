...
import traben.entity_texture_features.property_reading.RandomPropertiesFileHandler;
import traben.entity_texture_features.property_reading.RandomPropertyRule;
 ...
 *
 * @config_handling
 * These methods allow for retrieving, editing, replacing, and saving ETF's config<p>
 ...
 *
 * @resetting_ETF
 * API method that will reset ETF to recalculate after any changes<p>
 *      {@link ETFApi#resetETF()}
 *
 * @get_variant_textures
 * API methods for returning valid variant textures given an Entity, and it's default texture<p>
 ...
 *
 * @get_emissive_textures
 * API methods for returning valid emissive textures given an Entity, and it's default texture<p>
 ...
 *
 * @automatic_emissive_rendering
 * These methods will automatically find an entities emissive texture and render it on a given Model | ModelPart <p>
 ...
 *
 * @adding_custom_optifine_properties
 * This method allows registering custom {@link RandomProperty} objects to be included in OptiFine property file testing.<p>
 *      {@link ETFApi#registerCustomRandomPropertyFactory(RandomProperties.RandomPropertyFactory...)}
 *
 * @recent_rule_matches
 * These methods allow retrieving the latest matched OptiFine property rule index of a given entity.<p>
 *      {@link ETFApi#getLastMatchingRuleOfEntity(Entity)}<p>
 *      {@link ETFApi#getLastMatchingRuleOfBlockEntity(BlockEntity, Integer)}
 *
 * @optifine_property_reading
 * This method allows an external mod to send in the path of an OptiFine random properties file and return an object<p>
...
public class ETFApi {
     ...
     * <p>For example {@link traben.entity_texture_features.property_reading.properties.optifine_properties.BabyProperty#getPropertyOrNull(Properties, int)}
     * is the factory sent here for the object {@link traben.entity_texture_features.property_reading.properties.optifine_properties.BabyProperty}
     ...
     */
    public void registerCustomRandomPropertyFactory(RandomProperties.RandomPropertyFactory... factories){
    ...
    public static class ETFRandomTexturePropertyInstance {
         ...
         * @param isThisTheFirstTestForEntity
         *  provides context to allow for faster iterations when an entity needs to be
         ...
         * @param cacheToMarkEntitiesWhoseVariantCanChangeAgain
         * a FastUtil type of Map<UUID,boolean>. this map is for your own optimization usage as
