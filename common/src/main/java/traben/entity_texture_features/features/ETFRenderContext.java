...
//    }
//
//    public static void processVertexConsumer(VertexConsumerProvider provider, RenderLayer renderLayer) {
//
...
//todo this with the new mixin format
        //        currentETFTexture = null;
//
...
//                allowRenderLayerTextureModify();
//                //todo check vcp source works
//                return MinecraftClient.getInstance().getBufferBuilders().getEntityVertexConsumers().getBuffer(currentRenderLayer);
//            }
//        }
        return consumer;
    }
