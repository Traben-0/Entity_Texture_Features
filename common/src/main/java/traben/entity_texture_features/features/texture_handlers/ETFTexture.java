...
//    }
    ...
    private void setupBlinking() {
        if (ETF.config().getConfig().enableBlinking) {
            ...
            Optional<Resource> vanillaR1 = ETFUtils2.getResourceOptional(thisIdentifier);
            if (vanillaR1.isPresent()) {
                Identifier possibleBlinkIdentifier = ETFUtils2.replaceIdentifier(thisIdentifier, ".png", "_blink.png");
                Optional<Resource> blinkR1 = ETFUtils2.getResourceOptional(possibleBlinkIdentifier);
                if (blinkR1.isPresent()) {
                    ...
                    if (blink1PackName.equals(ETFUtils2.returnNameOfHighestPackFromTheseTwo(blink1PackName, vanillaR1.get().getResourcePackName()))) {
                        ...
                        Optional<Resource> blinkR2 = ETFUtils2.getResourceOptional(possibleBlink2Identifier);
                        ...
                        if (blinkingProps != null) {
                            Optional<Resource> propertyResource = ETFUtils2.getResourceOptional(propertyIdentifier);
...
//                    String pack;
//                    vanillaR1 = ETFUtils2.getResourceOptional(new Identifier(thisIdentifier.getNamespace(), thisIdentifier.getPath().replaceAll("_(.*?)(?=\\.png)", "")));
//                    if (vanillaR1.isPresent()) {
//                        pack = vanillaR1.get().getResourcePackName();
//                    }else{
//                        pack = "minecraft";
//                    }
//                    //create resource object sufficient for following code
//                    vanillaR1 = Optional.of(new ResourceImpl(pack, null,null,null));
//                }
                if (vanillaR1.isPresent()) {
                    Identifier possibleEmissiveIdentifier = ETFUtils2.replaceIdentifier(thisIdentifier, ".png", possibleEmissiveSuffix + ".png");
                    Optional<Resource> emissiveR1 = ETFUtils2.getResourceOptional(possibleEmissiveIdentifier);
...
//                        packs.add(vanillaR1.get().getResourcePackName());
                        if (emissivePackName.equals(ETFUtils2.returnNameOfHighestPackFromTheseTwo(emissivePackName, vanillaR1.get().getResourcePackName()))) {
                            ...
                            Optional<Resource> emissiveBlinkR1 = ETFUtils2.getResourceOptional(possibleEmissiveBlinkIdentifier);
                            if (emissiveBlinkR1.isPresent()) {
                                ...
                                if (emissiveBlinkPackName.equals(ETFUtils2.returnNameOfHighestPackFromTheseTwo(emissiveBlinkPackName, vanillaR1.get().getResourcePackName()))) {
                                    ...
                                    Optional<Resource> emissiveBlink2R1 = ETFUtils2.getResourceOptional(possibleEmissiveBlink2Identifier);
...
//                vanillaR1 = ETFUtils2.getResourceOptional(new Identifier(thisIdentifier.getNamespace(), thisIdentifier.getPath().replaceAll("_(.*?)(?=\\.png)", "")));
//                if (vanillaR1.isPresent()) {
//                    packName = vanillaR1.get().getResourcePackName();
//                } else {
//                    packName = "Default"; //todo correct namefor 1.19.2?
//                }
//                //create resource object sufficient for following code
//                vanillaR1 = Optional.of(new ResourceImpl(packName, null,null,null));
//            }
            if (vanillaR1.isPresent()) {
                Identifier possibleEnchantIdentifier = ETFUtils2.replaceIdentifier(thisIdentifier, ".png", enchantSuffix + ".png");
                Optional<Resource> enchantR1 = ETFUtils2.getResourceOptional(possibleEnchantIdentifier);
...
//                        packs.add(vanillaR1.get().getResourcePackName());
                    if (enchantPackName.equals(ETFUtils2.returnNameOfHighestPackFromTheseTwo(enchantPackName, vanillaR1.get().getResourcePackName()))) {
                        ...
                        Optional<Resource> enchantBlinkR1 = ETFUtils2.getResourceOptional(possibleEnchantBlinkIdentifier);
                        if (enchantBlinkR1.isPresent()) {
                            ...
                            if (enchantBlinkPackName.equals(ETFUtils2.returnNameOfHighestPackFromTheseTwo(enchantBlinkPackName, vanillaR1.get().getResourcePackName()))) {
                                ...
                                Optional<Resource> enchantBlink2R1 = ETFUtils2.getResourceOptional(possibleEnchantBlink2Identifier);
    ...
    private Identifier getBlinkingIdentifier(@Nullable ETFEntity entity) {
        ...
        }else if (((LivingEntity) entity).getPose() == EntityPose.SLEEPING) {
    ...
    public void assertPatchedTextures() {
        ...
        hasPatched = true;
                ...
                if ((ETFVersionDifferenceHandler.isThisModLoaded("iris") || ETFVersionDifferenceHandler.isThisModLoaded("oculus")) &&
                        //do pbr files exist?
                        (ETFUtils2.getResourceOptional(ETFUtils2.replaceIdentifier(thisIdentifier, ".png", "_s.png")).isPresent() ||
                                ETFUtils2.getResourceOptional(ETFUtils2.replaceIdentifier(thisIdentifier, ".png", "_n.png")).isPresent())
                ) {
                ...
                if (((ETFVersionDifferenceHandler.isThisModLoaded("animatica")) && (
                        ...
                        (ETFUtils2.getResourceOptional(ETFUtils2.replaceIdentifier(thisIdentifier, ".png", ".png.mcmeta")).isPresent() ||
                                ETFUtils2.getResourceOptional(ETFUtils2.replaceIdentifier(thisIdentifier, ".png", ".png.moremcmeta")).isPresent())
                )
                )) {
