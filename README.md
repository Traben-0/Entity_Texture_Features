...
This Fabric & Forge mod adds support for many  _Entity Texture Features :trollface:_, including many entity-related texture features, using the OptiFine's format player skin features!  
...
<img src="README-assets/blinkProperties.png" alt="img" width="250">
