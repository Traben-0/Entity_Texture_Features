...
//nvm lol modmenu requires it
//         if (FabricLoader.getInstance().isModLoaded("fabric")) {
//             category.addEntry(entryBuilder.startTextDescription(Text.of("""
//                             Fabric Api was not detected:
//                             - text in the menu may not appear
//                               correctly without fabric api"""))
...
//         }
        ...
        playerSkinSettings.add(1, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".enable_enemy_team_players_skin_features.title"), ETFConfigData.enableEnemyTeamPlayersSkinFeatures)
                ...
                .build()); // Builds the option entry for cloth config
        playerSkinSettings.add(2, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".skin_features_enable_transparency.title"), ETFConfigData.skinFeaturesEnableTransparency)
                .setDefaultValue(true) // Recommended: Used when user click "Reset"
                ...
                .build()); // Builds the option entry for cloth config
        playerSkinSettings.add(3, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".skin_features_enable_full_transparency.title"), ETFConfigData.skinFeaturesEnableFullTransparency)
                .setDefaultValue(false) // Recommended: Used when user click "Reset"
        ...
        category.addEntry(entryBuilder.startEnumSelector(Text.translatable("config." + ETFClient.MOD_ID + ".enchanted_potion_effects.title"), ETFConfig.EnchantedPotionEffectsEnum.class, ETFConfigData.enchantedPotionEffects)
                ...
                .build());
        category.addEntry(entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".enable_tridents.title"), ETFConfigData.enableTridents)
                .setDefaultValue(true) // Recommended: Used when user click "Reset"
