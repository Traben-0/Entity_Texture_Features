...
public class ETFUtils {
    ...
    private static boolean hidden_isFirstInSameOrDifferentHeightPack(Identifier first, Identifier second, boolean doSamePackCheck, boolean trueWhenDoingLowerCheck){
        try {
            ...
            String packname = resource.getResource(first).getResourcePackName();
            String packname2 = resource.getResource(second).getResourcePackName();
...
//    }
    ...
    public static void resetAllETFEntityData() {
        ...
        ELYTRA_MODELPART_TO_SKIP.clear();
    ...
    public static int return0123PathInHighestResourcePack(List<String> pathsToCheck,@Nullable String vanillaTwoPath){
        ...
        for (String path:
            ...
            if(!path.isEmpty()) {
                try {
                    String packName = manager.getResource(new Identifier(path)).getResourcePackName();
        ...
        if (vanillaTwoPath != null) {
            for (String noProperty :
                ...
                try {
                    String packName = manager.getResource(new Identifier(noProperty)).getResourcePackName();
