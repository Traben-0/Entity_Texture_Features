...
public class ETF_CLIENT {
    //this needs to be here instead of @see ETFClient due to puzzle mod compatibility, remove this when the full release happens
    //this is the Config / settings object used to customize ETF
    public static ETFConfig ETFConfigData = ETFClient.ETFConfigData;
}
